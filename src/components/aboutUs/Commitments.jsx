...
const Commitment = () => {
  return (
    <div className="about-commitment-wrapper">

      {/* Left Section - Info */}
      <div className="about-commitment-left-info">
        <div className="inovaya-title-heading">
        <h2>
          Water, our <strong>commitment</strong>
        </h2>
        </div>
      ...
      {/* Right Section -  Image */}
      <div className="about-commitment-right-image">
